...
# Możesz oczekiwać kilku różnych błędów, tak jakbyś używała składni 'elif', czyli:
try:
	value = wacky_funcktion_i_have_no_idae_whats_going_to_happen()
except ValueError:
	print('Nie wiem co z tym zrobić, ale dostałem błąd wartości!')
except TypeError:
	print('Mordo, coś Ci się typy pomyliły chyba.')
except SyntaxError:
	pritn('No, składnia nie taka jak trzeba. Weź to ogarnij')
